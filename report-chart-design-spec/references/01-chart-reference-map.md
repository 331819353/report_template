...
| Reusable relationship analysis card patterns: hub relation, correlation matrix, relation Sankey, community network, pair compare, relationship trend, hierarchy relation, bubble quadrant, factor ranking, evolution snapshot, bipartite relation, detail audit | `$report-component-style-design` `references/09b-relationship-analysis-card-patterns.md`, plus matching chart/table reference for the real `visualType` | Exact placement reference by renderer: scatter `12d3`, heatmap `12d8`, graph `12e5`, Sankey `12e6`, tree `12e4`, line `12c2`, bar `12c1`, or table placement |
