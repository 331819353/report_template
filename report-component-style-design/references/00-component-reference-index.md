...
| KPI cards, pyramid KPI cards, metric groups, comparison tiles, mini trends | `04-kpi-metric-cards.md`, plus `04a-kpi-card-patterns.md` for reusable card expressions | KPI, target attainment, YoY/MoM, target, sparkline, status, submetric tile, target-wave card, mini bar trend card, lead line trend card |
